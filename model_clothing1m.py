...
class DualNet(nn.Module):
    def __init__(self, num_class, dataset='cifar10'):
        ...
        self.net1.load_state_dict(torch.load('resnet50-11ad3fa6_v2.pth', weights_only=True), strict=False)
        self.net2.load_state_dict(torch.load('resnet50-11ad3fa6_v2.pth', weights_only=True), strict=False)
